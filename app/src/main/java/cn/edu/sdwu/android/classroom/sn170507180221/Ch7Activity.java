...
public class Ch7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    Toast.makeText(Ch7Activity.this, "on", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Ch7Activity.this, "off", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               //参数i，代表当前循环中的索引值
                ...
                Toast.makeText(Ch7Activity.this, content, Toast.LENGTH_SHORT).show();
            }
